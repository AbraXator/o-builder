...
function RecentCourseComponent({ setCurrentCourse, setPage }) {
...
function RecentCoursesPage({ setPage, setCurrentCourse }) {
  return (
    <div className="flex flex-col w-full h-full justify-center overflow-hidden">
      ...
      <div>
        <RecentCourseComponent setPage={setPage} setCurrentCourse={setCurrentCourse} />
      </div>
    </div>
  )
}
